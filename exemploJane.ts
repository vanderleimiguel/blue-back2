...
class Perfil {
  ...
  constructor({ nome, imagem = 'imagem padrão' }: IPerfilProps) {
    // como definimos acima que o parametro é opcional, se eu não passar uma imagem, a classe passa um valor padãro para o parametro
    this.nome = nome
    this.imagem = imagem
  }
